...
<p id="tabcap"> Table 6: Processed Data Summary </p> 																
|	Sector	|	Data	|	Map, Chart, Table, gif	|	Spatial Type	|	Spatial Scale	|	Temporal Scale	|	IIASA Folder name	|	Sources	|
|	:---------:	|	:---------:	|	:---------:	|	:---------:	|	:---------:	|	:---------:	|	:---------:	|	:---------:	|
|	Admin	|	Admin boundaries	|	Maps	|	Polygons	|	Country, Basin, Sub-basin	|	-	|	processed_admin_boundaries	|	~\cite{lehner2013_HYDROBASINS}	|
|	Admin	|	Population	|	Map, Chart, Table, Gif	|	Polygons, Raster	|	Country, Basin, Sub-basin	|	Annual	|	processed_admin_population	|	IIASA SSP2 RCP4 gridded projections	|
|	Admin	|	Road network	|	Map, Chart, Table, Gif	|	Polygons	|	Country, Basin, Sub-basin	|	-	|	processed_admin_roads	|	~\cite{OSM2017}	|
|	Water	|	Water temperature	|	Map, Chart, Table, Gif	|	Polygons, Raster	|	Country, Basin, Sub-basin	|	Daily	|	processed_water_temp	|	IIASA Water	|
|	Energy	|	Transmission lines	|	Maps, Table	|	Polygons	|	Country, Basin, Sub-basin	|	-	|	processed_energy_transmission	|	~\cite{WorldBank2017_PakTransmissionMap}	|
