...
NEST generates outputs inluding technology capacities, outputs and emissions for each geographic region. Moreover, NEST generates water resource use and availability . To facilitate efficient browsing and sharing of the data with both , NEST is accompanied by an interactive web-based results explorer (figure below). The explorer enables users to visualize and aggregate results for different regions and variables. Users can also export data directly for further analysis.
