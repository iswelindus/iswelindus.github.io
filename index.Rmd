---
title: "NExus Solutions Tool (NEST)"
...
<script>
   $(document).ready(function() {
     $head = $('#header');
     $head.prepend('<img src=\"figures/combined_logo.png\" style=\"float: center;width: 510px;\"/>')
   });
</script>
...
```{r, out.width = "350px", echo = FALSE, fig.align="right"}
knitr::include_graphics("figures/nest_funding.png")
```
